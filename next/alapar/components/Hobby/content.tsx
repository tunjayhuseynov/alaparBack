...
export const HtmlAdd = function HtmlAdd(this: React.Component<{}, Hobby> & StaticPages) {
    return (<>
...
export const HtmlFilter = function HtmlFilter(this: React.Component<{}, Hobby> & StaticPages) {
    return (<>
