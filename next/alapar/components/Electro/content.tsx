...
export const HtmlAdd = function HtmlAdd(this: React.Component<{}, Electro> & InstanceType<typeof add>) {
    return (<>
        ...
        {this.utility.selectGenerator("Marka:", this.state.computerMarkList, "computerMark", this.state.selected.computerMark, this.callbacks.commonCallback, { sort: true })}
        ...
        {this.utility.selectGenerator("Marka:", this.state.markList, "mark", this.state.selected.mark, this.callbacks.electroMarkCallback, { sort: true })}
        {this.utility.selectGenerator("Model:", this.state.modelList, "model", this.state.selected.model, this.callbacks.electroModelCallback, { sort: true })}
        ...
        {this.utility.inputGenerator("Elanın Adı:", "Daxil Edin", this.callbacks.textAreaCallback, "title", { visibility: this.state.categoryList?.find(w => w.id == this.state.selected.category)?.activateTitle })}
...
export const HtmlFilter = function HtmlFilter(this: React.Component<{}, Electro> & InstanceType<typeof add>) {
    return (<>
        ...
        {this.utility.selectGenerator("Növ:", this.state.typeList, "typeList", this.state.selected.typeList, this.callbacks.multipleCallback, { multiple: true })}

        {this.utility.selectGenerator("Operator:", this.state.operatorsList, "operatorList", this.state.selected.operatorList, this.callbacks.multipleCallback, { multiple: true })}
        ...
        {this.utility.selectGenerator("Rəng:", this.state.colorList, "colorList", this.state.selected.colorList, this.callbacks.multipleCallback, { loading: this.state.colorloading, multiple: true })}
        {this.utility.selectGenerator("Yaddaş:", this.state.storageList, "storageList", this.state.selected.storageList, this.callbacks.multipleCallback, { loading: this.state.storageloading, multiple: true })}
