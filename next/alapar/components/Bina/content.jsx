export const HtmlAdd = function HtmlAdd() {
    ...
    let sellingBox = <div className={'sellingTypeBox radioGroup'} style={{ textAlign: '' }}>
        ...
        {this.utility.checkBoxGenerator("Cixaris", this.callbacks.checkboxCallback, "licence", true)}

        {this.utility.checkBoxGenerator("Barter", this.callbacks.checkboxCallback, "barter", this.state.addition.barter)}

        {this.utility.checkBoxGenerator("Ipoteka", this.callbacks.checkboxCallback, "ipoteka", true)}
