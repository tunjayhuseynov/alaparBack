...
export const HtmlAdd = function HtmlAdd(this: React.Component<{}, Child> & InstanceType<typeof add>) {
    return (<>
...
export const HtmlFilter = function HtmlFilter(this: React.Component<{}, Child> & InstanceType<typeof add>) {
    return (<>
