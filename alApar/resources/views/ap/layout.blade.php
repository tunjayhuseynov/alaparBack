...
<?php  
$mainPath = explode("/",Request::path())[0];
?>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url($mainPath) }}">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url($mainPath) }}">
        ...
        <li class="nav-item">
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    @foreach($globalShare["ad_packages"] as $item)
                        <a class="collapse-item"
                            href="{{ url($mainPath.'/elanlar/'.$item->id) }}">{{ $item->name }}</a>
                    @endforeach
                </div>
            </div>
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ url($mainPath.'/elanElaveEt') }}">Elan Əlavə
                        Et</a>
                </div>
            </div>
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    @foreach($globalShare["yanTableNames"] as $name)
                        <a class="collapse-item"
                            href="{{ url($mainPath.'/yanDb/'.$name) }}">{{ $name }}</a>
                    @endforeach
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span
                                class="mr-2 d-none d-lg-inline text-gray-800 medium">{{ Session::get("name") }}</span>
                            <img class="rounded-circle" src={{ Session::get("url") }}
